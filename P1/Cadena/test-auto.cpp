...
FCT_BGN() {
  FCT_SUITE_BGN(Cadena) {
    ...
    FCT_TEST_BGN(Ctor: por copia de otra sub-Cadena) {
      ...
      fct_chk(strcmp(b, "casa") == 0);
      fct_chk(strcmp(c, "casa de sucios") == 0);
      fct_chk(strcmp(d, a) == 0);
      fct_chk(strcmp(e, "") == 0);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Ctor: N primeros caracteres de cadena de C) {
      ...
      fct_chk(strcmp(a, "No te digo trigo") == 0);
      fct_chk(strcmp(b, "") == 0);
      fct_chk(strcmp(c, "Mary had a little lamb") == 0);
    }
    FCT_TEST_END();
    ...
    FCT_TEST_BGN(Concatenacion: con +) {
      ...
      Cadena c = a + b;
      fct_chk(strcmp(a + b, "Cada cual, en su corral") == 0);
    }
    FCT_TEST_END();
