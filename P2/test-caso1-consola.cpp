/* $Id: test-caso1-consola.cpp 219 2015-04-11 20:47:02Z gerardo $
 * Comprobación de las clases Articulo, Usuario, Tarjeta y
 * asociadas: Clave y Numero
 * LIBRERÍA
 * ©2009-15 Los profesores de POO
 */
...
int main()
{
  ...
  Tarjeta 
    ...
    american_express(Numero("378282246310005"), hanna, Fecha(30,11,0) + 4*365),
  ...
  mostrar_carro(std::cout, krispin);
  std::cout << "\n*** krispin devuelve STL y compra POO" << std::endl;
